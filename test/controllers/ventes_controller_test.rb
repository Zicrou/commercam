...
class VentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vente" do
    assert_difference("Vente.count") do
      post ventes_url, params: { vente: { category: @vente.category, name: @vente.name, price: @vente.price } }
    end
  ...
  test "should update vente" do
    patch vente_url(@vente), params: { vente: { category: @vente.category, name: @vente.name, price: @vente.price } }
